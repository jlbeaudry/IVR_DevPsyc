...
I used the  R package `effectsize` [@R-effectsize] to calculate 
partial eta squared (n~p~^2^) with 90% confidence intervals for these effects 
(but, I report their V, F, and p values). 
...
I used the `BSDA` R package [@R-BSDA] to conduct independent 
