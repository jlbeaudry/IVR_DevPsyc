...
(VC assessment vs. traditional CPT) and clinical status (children with ADHD 
[n = `r df_negut$adhd_n[1]`] vs. typically-developing children 
[n = `r df_negut$td_n[1]`]), and one within-subjects factor: test modality 
...
`r round(clin_eta$CI_high, 3)`]). I used the `BSDA` R package 
[@arnholt_bsda_2017] to conduct independent t-tests comparing the children 
with ADHD  with the typically-developing children on errors of commission, errors 
of omission, and total correct responses 
