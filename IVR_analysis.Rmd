...
Cohen's f: small = .10, medium = .25, large = .40 {for one-way ANOVAs} \newline
...
partial eta squared (np^2^) with 90% confidence intervals for these effects 
...
Measures: 
  + Paola reported Emotiona expression & regulation (PEP-3), social interaction 
...
different, I used the `BSDA` R package [@arnholt_bsda_2017] to conduct
