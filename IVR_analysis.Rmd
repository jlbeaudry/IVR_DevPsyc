...
are large effects (they did not report the confidence intervals around the f
value.)
...
[@R-BSDA] to compute the t-test statistic based on the summary
statistics reported in the paper. I also used the `compute.es` R package 
[@R-compute.es] to calculate the effect size 
...
THERE'S ONLY ONE ANALYSIS, SO I CAN PUT THAT IN A SENTENCE...
...
I have used the R package `effsize` [@R-effsize] to calculate the effect size 
...
Wsing the base R stats package [@R-base], we tried to reproduce this analysis, but our 
...
transformed pain tolerance scores. This ANOVA showed a signi
